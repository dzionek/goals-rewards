...
class TestRoutes:
    def test_log_in_get(self, client, default_user):
    ...
    def test_login_post_valid(self, client, default_user):
    ...
    def test_login_post_invalid_password(self, client, default_user):
        response = client.post(
    ...
    def test_login_post_invalid_login(self, client, default_user):
        response = client.post(
    ...
    def test_log_out(self, client, default_user):
    ...
    def test_register_get(self, client, default_user):
